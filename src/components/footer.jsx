        ...
        <footer className="h-screen bg-gradient-to-b from-navy to-[#001D31] text-creamBG font-bricolage-grotesque flex flex-row justify-between items-center px-horizontal py-20">
            <div className="flex flex-col justify-between h-full">
                <div className="flex flex-col text-6xl gap-4">
                    ...
                    <Button href="/CARDENAS_Resume.pdf" download={true} variant="link2" className=" no-underline">Resume</Button>
                </div>
            ...
            <div className="flex flex-col text-right justify-between h-full">
                ...
                <div className="flex flex-col items-end gap-4">
                    ...
                    <Button href="https://discordapp.com/users/758302953974399017" variant="outlined" newTab={true} className="flex flex-row gap-2">Discord <ArrowUpRight className="w-auto h-auto"/></Button>
                </div>
            </div>
        </footer>
    );
